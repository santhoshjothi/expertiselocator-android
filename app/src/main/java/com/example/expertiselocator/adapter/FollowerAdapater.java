...
public class FollowerAdapater extends BaseAdapter {

    private List<FollowingListResponse> followingListResponseList;
    private Context context;
    private LayoutInflater thisInflater;
    FollowersActivity followersActivity;
    public FollowerAdapater(FollowersActivity followersActivity, List<FollowingListResponse> followingList) {
        this.followingListResponseList = followingList;
        this.context = followersActivity;
        this.thisInflater = LayoutInflater.from(context);
        this.followersActivity=(FollowersActivity)context;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        FollowerAdapater.MyViewHolder holder = new FollowerAdapater.MyViewHolder();
        View rowView;
        ...
        holder.follwinglist_profile_menu.setOnClickListener(View ->{
            followersActivity.onItemClick(View ,i);
