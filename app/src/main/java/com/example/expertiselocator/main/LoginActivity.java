            ...
            public void onResponse(@NonNull Call<LoginResponse> call, @NonNull Response<LoginResponse> response) {
                ...
                try {
                    if (loginResponse.getToken() != null) {
                        prefs.putString(commonMethods.expertiseLoginToken, loginResponse.getToken());
                        prefs.commit();
    ...
    public void callGetUserInfo(UserInfoRequest userInfo, String token) {
        ...
        getPostedMessage.enqueue(new Callback<List<GetUserInfoResponse>>() {
            ...
            public void onResponse(@NonNull Call<List<GetUserInfoResponse>> call, @NonNull Response<List<GetUserInfoResponse>> response) {
                String userId = null, UserNameInfo = null, firstNameInfo = null,
                        lastNameInfo = null, userProfileImage = null, profilePicture = null;
                commonMethods.showLog("URL Success : ", TAG + call.request().url());
                commonMethods.showLog("Response Code : ", TAG + response.code());
                commonMethods.showLog("Response Body : ", TAG + response.body());
                ...
                try {
                    ...
                    for (int i = 0; i < loginResponse.size(); i++) {
                        ...
                        firstNameInfo = loginResponse.get(i).getFirstName();
                        lastNameInfo = loginResponse.get(i).getLastName();
                        profilePicture = loginResponse.get(i).getProfilePicture();
                    ...
                    String firstNamDecrpt = decrypt(firstNameInfo, "8080808080808080");
                    ...
                    userDetailPreferences.setFirstName(firstNamDecrpt);
                    ...
                    prefs.putString(commonMethods.expertiseUserInfo, userInfoListJsonString);
                    prefs.commit();
                    progress_login.setVisibility(View.GONE);
